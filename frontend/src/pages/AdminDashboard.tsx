...
export default function AdminDashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center">
        <div className="text-xl font-bold tracking-widest uppercase animate-pulse">Cargando Órdenes...</div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-display uppercase tracking-wider mb-8">Panel de Administración</h1>

      {error && (
        <div className="bg-red-50 text-red-600 p-4 mb-8 border border-red-200">
          {error}
        </div>
      )}
